...
public enum ErrorCode {
    ...
    INVALID_LEAVE_CANCEL_STATUS(HttpStatus.BAD_REQUEST, "이미 처리된 신청은 취소할 수 없습니다."),
    INVALID_HALF_LEAVE_DATE(HttpStatus.BAD_REQUEST, "반차는 시작일과 종료일이 같아야 합니다."),
    ...
    LEAVE_NOT_FOUND(HttpStatus.NOT_FOUND, "연차 신청 정보를 찾을 수 없습니다."),
    OVERTIME_NOT_FOUND(HttpStatus.NOT_FOUND, "특근 신청 정보를 찾을 수 없습니다."),
    INVALID_OVERTIME_CANCEL_STATUS(HttpStatus.BAD_REQUEST, "이미 처리된 신청은 취소할 수 없습니다."),
    INVALID_OVERTIME_TIME(HttpStatus.BAD_REQUEST, "특근 종료 시간은 시작 시간보다 빠를 수 없습니다."),
    INVALID_OVERTIME_PERIOD(HttpStatus.BAD_REQUEST, "특근은 하루 단위로만 신청 가능합니다."),
